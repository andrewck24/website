...
export interface LinkedInAnimatedIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface LinkedInAnimatedIconProps extends HTMLMotionProps<"div"> {
  size?: number;
}

const LinkedInAnimatedIcon = forwardRef<
  LinkedInAnimatedIconHandle,
  LinkedInAnimatedIconProps
...
export { LinkedInAnimatedIcon, LinkedinIcon };
