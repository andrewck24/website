...
export interface GithubAnimatedIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface GithubAnimatedIconProps extends HTMLMotionProps<"div"> {
  size?: number;
}

const GithubAnimatedIcon = forwardRef<
  GithubAnimatedIconHandle,
  GithubAnimatedIconProps
...
export { GithubAnimatedIcon, GithubIcon };
